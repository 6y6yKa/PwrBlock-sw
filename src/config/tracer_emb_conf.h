...
#define TRACER_EMB_IS_INSTANCE_LPUART_TYPE                                     \
    0UL /* set to 0UL if USART is used                                         \
         */
...
#define TRACER_EMB_ENABLE_CLK_USART()                                          \
    LL_APB1_GRP1_EnableClock(LL_APB1_GRP1_PERIPH_USART3)
#define TRACER_EMB_DISABLE_CLK_USART()                                         \
    LL_APB1_GRP1_DisableClock(LL_APB1_GRP1_PERIPH_USART3)
#define TRACER_EMB_SET_CLK_SOURCE_USART(                                                       \
)                                   /* No need for clock source selection in case of USART3 // \
                                       LL_RCC_SetUSARTClockSource(LL_RCC_USART3_CLKSOURCE_PCLK2) */
